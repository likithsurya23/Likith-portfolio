                    ...
                    <div className="flex items-center justify-between">
                        ...
                        >
                            <div className="relative">
                                <div
                                    className="w-9 h-9 md:w-11 md:h-11 flex items-center justify-center rounded-xl 
                                ...
                                {navLinks.map((link, i) => (
                                    ...
                                    >
                                        ...
                                        <div className="relative flex items-center justify-between px-6 py-4">
                                            <span
                                                className={`text-lg font-medium transition-colors duration-200 ${activeSection === link.id
                                                        ? "text-white dark:text-black"
